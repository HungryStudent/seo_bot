...
async def analytics(call: CallbackQuery):
    await call.message.answer("""Когда карточка оформлена но продаж все равно недостаточно, очень важно оценить карточку товара, найти слабые места, а затем улучшить их. 
